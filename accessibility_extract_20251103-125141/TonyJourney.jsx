        ...
        <>
            ...
            <div className="relative w-full flex justify-center bg-white mb-0 pb-0">
                <div className="relative z-10 w-[80%] aspect-[16/9] rounded-3xl overflow-hidden shadow-2xl bg-black">
                    ...
                    <div className="absolute bottom-0 w-full h-[40%] bg-gradient-to-b from-transparent via-[#7d1f97]/50 to-black/90 pointer-events-none" />
                    <div className="absolute bottom-0 w-full h-[40%] bg-gradient-to-r from-transparent via-[#952ca8]/18 to-transparent animate-pulseGlow pointer-events-none" />
                </div>
