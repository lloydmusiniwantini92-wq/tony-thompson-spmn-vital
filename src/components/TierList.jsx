...
import step4 from "../assets/quiz/step4.png";
...
export default function TierList() {
    const { openQuiz } = useQuizOverlay(); // (kept if you need it elsewhere)
    ...
    return (
        <section
            id="programs" // ← this is the only anchor the quiz scrolls to
        ...
        >
            ...
            {/* === ASPIRE COUNTDOWN (Minimal / Unframed Edition) === */}
            <AnimatePresence>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                    {tiers.map((tier, i) => (
                        ...
                        >
                            ...
                            {/* === UNIFIED BUTTON STYLE FOR ALL TIERS === */}
                            <motion.button
            ...
            {/* === COMPARISON CHART — PURPLE BACKGROUND === */}
            <motion.div
            ...
            >
                <motion.div
                    ...
                    className="absolute inset-0 opacity-[0.12] bg-[radial-gradient(circle_at_50%_20%,rgba(155,38,182,0.5),transparent_70%)]"
                />

                <motion.div
                    className="absolute top-[2.9rem] left-1/2 -translate-x-1/2 w-[240px] h-[2px]
                ...
                <h3
                    className="relative text-4xl md:text-5xl font-extrabold
                     ...
                     bg-gradient-to-r from-white via-[#f2e0ff] to-white
                     text-center tracking-tight mb-12 drop-shadow-[0_0_25px_rgba(255,255,255,0.2)]"
                >
                    Compare Programs
                </h3>
                ...
                <div className="relative max-w-7xl mx-auto overflow-x-auto border border-white/10 backdrop-blur-[2px]">
                    <div
                        className="grid grid-cols-4 min-w-[900px] divide-x divide-white/20
                    ...
                    >
                        ...
                        {["ASPIRE", "IGNITE", "ELEVATE"].map((tier, i) => (
                            <motion.div
                                ...
                                className="py-6 text-[1.35rem] font-extrabold uppercase text-center tracking-widest
                           bg-[#9b26b6]/25 text-white border-b border-white/10"
                            >
                                {tier}
                            </motion.div>
                        ))}
                        ...
                        {comparisonData.map((row, i) => (
                            <React.Fragment key={i}>
                                <motion.div
                                    ...
                                    className="text-left text-sm md:text-base py-5 px-4
                             text-white/90 border-t border-white/10
                             bg-[#7f1aa1]/20"
                                >
                                    {row.feature}
                                </motion.div>
                                ...
                                {["aspire", "ignite", "elevate"].map((key) => (
                                    <motion.div
                                        ...
                                        className="text-center py-5 border-t border-white/10
                               bg-[#9b26b6]/20 transition-all duration-200"
                                    >
                                        {row[key] ? (
                                            <motion.span
                                                initial={{ opacity: 0, scale: 0.8 }}
                                                whileInView={{ opacity: 1, scale: [1, 1.4, 1] }}
                                                viewport={{ once: true }}
                ...
                <div className="absolute -bottom-[1px] left-0 w-full h-[1px]
