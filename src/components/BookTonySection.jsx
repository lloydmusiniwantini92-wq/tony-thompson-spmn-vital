            ...
            (entries) => {
                entries.forEach((entry) => {
                    if (entry.isIntersecting) {
                        ...
                        if (!isMobile && !hasPlayed && videoRef.current) {
            ...
            <div className="fixed inset-0 z-[2147483650] flex items-end justify-center pb-[8vh] pointer-events-none">
                <button
                    ...
                    className="
                        ...
                        font-['Press_Start_2P']
                        text-[1rem] md:text-[1.35rem] tracking-[0.18em]
                        rounded-full
                    ...
                    "
                >
                    <span className="relative z-10 group-hover:-translate-y-[150%] group-hover:opacity-0 transition-all duration-500">
                        WIN
                    </span>
                    <span className="absolute z-10 opacity-0 translate-y-[150%] group-hover:opacity-100 group-hover:translate-y-0 transition-all duration-500">
                        NOW
                    </span>
                        ...
                        >
                            ...
                            <div
                                className="
                                    ...
                                    w-[240px] md:w-[280px] h-[70px] md:h-[80px]
                                ...
                                <div className="relative w-full h-full flex items-center justify-center">
                                    <span
                                        className="
                                            ...
                                            text-[1.1rem] md:text-[1.35rem] tracking-[0.18em] drop-shadow-md
