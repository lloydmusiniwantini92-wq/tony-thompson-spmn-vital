...
// ⭐ BUTTON COMPONENT (Mobile sizing is Industry Standard ~56px height)
...
export default function MeetTony() {
    ...
    // This is the function responsible for the navigation
...
            ========================================================= */}
            <div className="absolute inset-0 z-0 overflow-hidden">
                <motion.img
                    ...
                    // ⭐ IMAGE ALIGNMENT: Mobile locked at 57% (X) 45% (Y). Desktop locked at 85% center.
                    className="w-[125%] max-w-none h-full object-cover object-[57%_45%] md:object-[85%_center] will-change-transform"
                />
            </div>
...
            ========================================================= */}
            ...
            {/* =========================================================
            📱 MOBILE LAYOUT (Text Top, Button Bottom)
            ========================================================= */}
            <div className="relative z-20 flex md:hidden h-screen items-start justify-center text-center text-white pointer-events-none">
                <div className="absolute inset-0 bg-gradient-to-t from-[#7d1f97]/90 via-[#000]/40 to-transparent" />

                {/* --- TEXT GROUP (Top Aligned) --- */}
                <div className="relative z-[2] px-[6vw] max-w-[1000px] mt-[5cm] pointer-events-auto">
                    <motion.h1
                        variants={fadeUp}
                        initial="hidden"
                ...
                {/* --- BUTTON (Absolute Bottom Center) --- */}
                <motion.div
                    // This is the functional click handler for mobile
                    ...
                    whileTap={{ scale: 0.97 }}
                    // pointer-events-auto ensures the click registers
                    className="absolute bottom-[12%] left-1/2 -translate-x-1/2 z-[10] cursor-pointer group select-none pointer-events-auto"
                >
...
            ========================================================= */}
            <div className="hidden md:flex relative z-20 flex-1 pointer-events-none">
                {/* LEFT PANEL - Pointer events are 'auto' here, allowing the click. */}
                <div className="w-1/3 flex flex-col justify-center min-h-[60vh] pointer-events-auto">
                    <div className="px-[6vw] py-[6vh] flex flex-col flex-1 text-white">
                        ...
                        <motion.div
                            // This is the functional click handler for desktop
                            onClick={scrollToJourney}
                            variants={fadeUp}
                            initial="hidden"
                            animate={inView ? "visible" : "hidden"}
